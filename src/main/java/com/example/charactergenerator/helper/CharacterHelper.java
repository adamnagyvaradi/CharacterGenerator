    ...
    private List<Character> getCharacters(){
        return new ArrayList<>(Arrays.asList(
                ...
                new Character("Wight", 14, 45, "6d8 + 18", "30 ft.", 3,
                        ...
                        Set.of(SkillType.PERCEPTION, SkillType.STEALTH)).equipArmor(getArmorByID((3l))).equipMeleeWeapon(getMeleeWeaponByID((14l))).equipRangedWeapon(getRangedWeaponByID((8l))),
